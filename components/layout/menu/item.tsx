...
export function Item({ icon, children, href }: ItemProps) {
  ...
  return (
    <Link
      href={href}
      className={`flex h-11 items-center ${isSidebarExpanded ? "justify-start" : "justify-center"} gap-2.5 px-6 py-2.5 text-[#bfbfbf] ${isActive(href) ? "bg-[#ffffff0d] text-white" : ""} delay-150 hover:bg-[#262626]`}>
